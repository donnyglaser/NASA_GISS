...
argInput <- commandArgs(trailingOnly = TRUE)
iyr <- argInput[1]
imon <- argInput[2]
...
print(paste0('Obj 1 Time: ', runTime))
runTime <- Sys.time() - runTime1
print(paste0('Total Elapsed Time: ', runTime))
runTime <- Sys.time()
###### TESTING ######
...
###### TESTING ######
runTime <- Sys.time() - runTime
print(paste0('Obj 2 Time: ', runTime))
runTime <- Sys.time() - runTime1
print(paste0('Total Elapsed Time: ', runTime))
runTime <- Sys.time()
###### TESTING ######
...
###### TESTING ######
runTime <- Sys.time() - runTime
print(paste0('Obj 3 Time: ', runTime))
runTime <- Sys.time() - runTime1
print(paste0('Total Elapsed Time: ', runTime))
runTime <- Sys.time()
###### TESTING ######
...
###### TESTING ######
runTime <- Sys.time() - runTime
print(paste0('Obj 4 Time: ', runTime))
runTime <- Sys.time() - runTime1
print(paste0('Total Elapsed Time: ', runTime))
runTime <- Sys.time()
###### TESTING ######
...
###### TESTING ######
runTime <- Sys.time() - runTime
print(paste0('Obj 5 Time: ', runTime))
runTime <- Sys.time() - runTime1
print(paste0('Total Elapsed Time: ', runTime))
runTime <- Sys.time()
###### TESTING ######
...
###### TESTING ######
runTime <- Sys.time() - runTime
print(paste0('Obj 6 Time: ', runTime))
runTime <- Sys.time() - runTime1
print(paste0('Total Elapsed Time: ', runTime))
runTime <- Sys.time()
###### TESTING ######
...
for(ilon in 1:length(lonList)){ ## subset at specific long
    ...
    for(ipres in 1:length(pComp)) { ## subset at specific pressure
        ...
        if(length(naPTab) > 0) { ## this checks to see if there are any data at the P level
            ...
            tOut <- cbind(pSub[1,1:3], MCSlatLevels, pSub[1,5], NA)
            colnames(tOut) <- colnames(pSub)
            interpOut <- rbind(interpOut, tOut)
        }
    }
}
...
###### TESTING ######
runTime <- Sys.time() - runTime
print(paste0('Obj 7 Time: ', runTime))
runTime <- Sys.time() - runTime1
print(paste0('Total Elapsed Time: ', runTime))
runTime <- Sys.time()
###### TESTING ######
...
###### TESTING ######
runTime <- Sys.time() - runTime
print(paste0('Obj 8 Time: ', runTime))
runTime <- Sys.time() - runTime1
print(paste0('Total Time: ', runTime))
###### TESTING ######
